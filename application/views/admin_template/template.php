            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Data Kas:</h6>
                        <a class="collapse-item" href="<?= base_url('pengelola/kasorganisasi/dashboard/') ?>">Organisasi</a>
                        <a class="collapse-item" href="<?= base_url('pengelola/kaskurban/dashboard/') ?>">Qurban</a>
                    </div>
                </div>
            </li>

            <!-- Nav Item - Data Management User -->
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('pengelola/user/anggota/') ?>">Anggota</a>
                        <a class="collapse-item" href="<?= base_url('pengelola/user/donatur/') ?>">Donatur</a>
                    </div>
                </div>
            </li>

            <!-- Nav Item - Data Management Posting Pengumuman -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#datamanagementartikel" aria-expanded="true" aria-controls="collapseUtilities">
                    <i class="fas fa-newspaper"></i>
                    <span>Pengelolaan Artikel</span>
                </a>
                <div id="datamanagementartikel" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Artikel / Pengumuman:</h6>
                        <a class="collapse-item" href="<?= base_url('pengelola/blog/artikel/dashboard') ?>">Data</a>
                    </div>
                </div>
            </li>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <img class="img-profile rounded-circle" src="<?= base_url('upload/user_img/') . $profile->User_img; ?>">
                        </a>
